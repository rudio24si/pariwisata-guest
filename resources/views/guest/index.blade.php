        ...
        <div class="mxd-hero-07">
            <div class="mxd-hero-07__wrap loading-wrap">
                ...
                <div class="mxd-hero-07__top">
                    <h1 class="mxd-hero-07__title">Design. Development. Digital Art. Branding.</h1>
        ...
        <div class="mxd-container grid-container">
            ...
            <div class="mxd-block">
                <div class="mxd-projects-list hover-reveal">
                    ...
                    <a class="mxd-projects-list__item hover-reveal__item" href="{{ route('destinasi.show', $item->destinasi_id) }}">
                        <div class="mxd-projects-list__border anim-uni-in-up"></div>
                        <div class="hover-reveal__content hover-reveal-360x440">
                            <img class="hover-reveal__image" src="{{asset('uploads/destinasi/'.$item->gambar)}}" alt="Project Preview">
                        </div>
                                ...
                                <div class="row gx-0">
                                    <div class="col-12 col-xl-6 mxd-grid-item no-margin">
                                        ...
                                        <div class="mxd-projects-list__image anim-uni-in-up">
                                            <img src="{{asset('uploads/destinasi/'.$item->gambar)}}" alt="Project Preview">
                                        </div>
                                    </div>
                        ...
                        <div class="col-12 col-xl-8 mxd-grid-item no-margin">
                            <div class="mxd-block__content">
                                <div class="mxd-block__manifest centered anim-uni-in-up">
                                    <p class="mxd-manifest mxd-manifest-l reveal-type">Pariwisata desa, atau yang sering dikenal sebagai Desa Wisata, kini menjadi tren yang diminati oleh banyak wisatawan, menawarkan alternatif yang menyegarkan dari hiruk pikuk kota. Konsep ini berfokus pada pengalaman otentik, di mana desa tidak hanya menjadi lokasi kunjungan, tetapi juga destinasi yang hidup dan berinteraksi dengan pengunjung.</p>
                                    <div class="mxd-manifest__controls anim-uni-in-up">
                                        <div class="mxd-btngroup centered">
                                            <a class="btn btn-anim btn-default btn-accent slide-right-up" href="works-simple.html">
                ...
                <a class="btn-rotating btn-rotating-blur-outline ver-02" href="contact.html">
                    ...
                    <svg version="1.1" id="scrollDown" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                        ...
                        <g>
                            ...
                            <text>
                                <!-- button text here!!! -->
                                <textPath xlink:href="#textPath">* Let's Booking * Let's Booking * Let's Booking *</textPath>
                            </text>
                        </g>
                    </svg>
                </a>
                ...
                <div class="mxd-section-title pre-grid">
                    <div class="container-fluid p-0">
                        <div class="row g-0">
                            ...
                            <div class="col-12 col-xl-4 mxd-grid-item no-margin">
                                <div class="mxd-section-title__hrdescr">
                                    <p class="anim-uni-in-up">Kenali pemandu wisata lokal kami yang berpengalaman dan siap membantu perjalanan Anda.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-12 col-xl-4 mxd-team-cards__item mxd-grid-item animate-card-3">
                                <div class="mxd-team-cards__inner">
                                    <div class="mxd-team-cards__image">
                                        @if($guide->foto)
                                        <img src="{{ asset('uploads/warga/' . $guide->foto) }}" alt="{{ $guide->nama }}">
                                        @else
                                        <img src="https://ui-avatars.com/api/?name={{ urlencode($guide->nama) }}&size=400&background=2E8B57&color=fff" alt="{{ $guide->nama }}">
                                        @endif
                                    </div>
                                    <div class="mxd-team-cards__data">
                                        ...
                                        @if($guide->pengalaman)
                                        <p class="t-small anim-uni-in-up text-muted">
                                        ...
                                        @endif
                                        <div class="mxd-team-cards__contact anim-uni-in-up">
                                            <a href="tel:{{ $guide->telp }}" class="btn btn-anim btn-default btn-sm btn-outline slide-right-up">
