            ...
            <div class="mxd-container grid-container">
                ...
                <div class="mxd-block loading-wrap">    
                    <div class="container-fluid px-0">
                            ...
                            <div class="col-12 col-xl-10 mxd-grid-item no-margin">
                                <div class="mxd-block__content">
                                    <div class="mxd-block__inner-headline loading__item">
                                        <h1 clas s="inner-headline__title">Data Warga</h1>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <form method="GET" action="{{ route('allData_warga') }}" onchange="this.form.submit()" class="mb-3">
                            <div class="row">
                                <!-- <div class="col-md-2">
                                ...
                                <div class="col-sm-3 mb-3 mb-sm-0">
                                    <div class="card m-3">
                                        <div class="card-body bg-white p-3 rounded-5">
                                            <h5 class="card-title text-black">{{$w->nama}}</h5>
                                            <p class="card-text text-secondary">{{$w->email}}</p>
                        ...
                        <div class="mt-3">
                            <span class="text-light">{{ $warga->links('pagination::bootstrap-5') }}</span>
                        </div>
                    </div>
