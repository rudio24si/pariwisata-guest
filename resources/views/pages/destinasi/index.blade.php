...
@section('content')
    ...
    <main id="mxd-page-content" class="mxd-page-content">
        ...
        <div class="whatsapp-float">
            <a href="#pemanduLokal" target="_blank" class="whatsapp-link" aria-label="Hubungi kami via WhatsApp">
                                    ...
                                    <div class="mxd-block__manifest centered anim-uni-in-up">
                                        ...
                                        <div class="mxd-manifest__controls anim-uni-in-up">
                                            <div class="mxd-btngroup centered">
                                                <a class="btn btn-anim btn-default btn-accent slide-right-up" href="#">
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-12 col-xl-3 mxd-grid-item no-margin">
                                    <div class="mxd-section-title__hrcontrols anim-uni-in-up">
                                        <a class="btn btn-anim btn-default btn-outline slide-right-up"
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-12 col-xl-4 mxd-blog-preview__item mxd-grid-item animate-card-3">
                                    ...
                                    <div class="mxd-blog-preview__data">
                                        <a class="anim-uni-in-up" href="blog-article.html"><span>Frontend innovations</span>
                                            and user journeys</a>
                                    </div>
                                </div>
                                <!-- item -->
                                <div class="col-12 col-xl-4 mxd-blog-preview__item mxd-grid-item animate-card-3">
                                    ...
                                    <div class="mxd-blog-preview__data">
                                        <a class="anim-uni-in-up" href="blog-article.html">Branding in creating
                                            <span>digital experiences</span></a>
                                    </div>
                                </div>
                                <!-- item -->
                                <div class="col-12 col-xl-4 mxd-blog-preview__item mxd-grid-item animate-card-3">
                                    ...
                                    <div class="mxd-blog-preview__data">
                                        <a class="anim-uni-in-up" href="blog-article.html">Elevating <span>digital
                                                workshops</span> with engaging design</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="mxd-section padding-default" id="pemanduLokal">
            <div class="mxd-container grid-container">
                ...
                <div class="mxd-manifest__controls anim-uni-in-up">
                    <div class="mxd-btngroup">
                        <a class="btn btn-anim btn-default btn-accent slide-right-up" href="{{route('warga.create')}}">
                            <span class="btn-caption">Tambah pemandu</span>
                            <i class="ph-bold ph-arrow-up-right"></i>
                        </a>
                    </div>
                </div>
                <div class="mxd-manifest__controls anim-uni-in-up d-flex justify-content-center">
                    <div class="mxd-btngroup">
                        <a class="btn btn-anim btn-default btn-accent slide-right-up" href="{{route('allData')}}">
                            <span class="btn-caption">Lihat semua data</span>
                            <i class="ph-bold ph-arrow-up-right"></i>
                        </a>
                    </div>
                </div>
