...
<head>
    ...
    <title>Login - Pariwisata Indonesia</title>
...
<body>
    <div class="container">
        <div class="form-container">
            ...
            <form action="{{ route('login.process') }}" method="POST">
                ...
                <div class="input-group">
                    <label class="input-label" for="name">Username atau Email</label>
                    <input type="text" name="name" id="name" class="input-field"
                        placeholder="Masukkan username atau email" value="{{ old('name') }}" required>
                    @error('name')
        ...
        <div class="image-container">
            ...
            <p>Masuk untuk mengakses informasi lengkap tentang destinasi wisata, paket perjalanan, dan promo menarik.</p>

            <div class="benefits-list">
                <h3>Manfaat Bergabung:</h3>
                <ul>
                    <li>Akses ke destinasi wisata eksklusif</li>
                    <li>Promo dan penawaran khusus</li>
                    <li>Panduan perjalanan terpercaya</li>
                    <li>Komunitas traveler Indonesia</li>
                </ul>
            </div>
        </div>
    </div>
